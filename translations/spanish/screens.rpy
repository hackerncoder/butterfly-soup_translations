...
translate spanish style namebox:
...
style say_dialogue:
    ...
    ypos 0
    line_spacing 2
translate spanish style say_dialogue:
    font "arial.ttf"
    size 32
...
style main_menu_button:
    left_padding 9
    right_padding 9
translate spanish style main_menu_button: #optional, only japanese and korean have it in the official
    left_padding 24
    right_padding 24
...
style game_menu_content_frame:
    ...
    right_margin 120
    top_margin 10
translate spanish style game_menu_content_frame: #(official comment) doesn't seem to do anything?
...
translate spanish style about_text: #about page text
    font "arial.ttf"
    size 20
